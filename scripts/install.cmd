...
:: ASI_LOADER_NAME is the filename the ASI DLL is renamed to. SWtD only loads
:: dinput8.dll from System32 (restricted-search LoadLibrary), so the loader
:: must proxy a static EXE import: winmm.dll (dwmapi.dll is taken by UE4SS).
